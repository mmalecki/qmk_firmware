...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_ortho_5x14(
        KC_ESC,  KC_NUMBERS_L,                                         KC_NUMBERS_R,                       KC_MINS, KC_EQL,  KC_GRV,
        KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_LBRC, KC_RBRC, KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSPC,
        KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_BSLASH, KC_QUOTE, KC_H, KC_J,    KC_K,    KC_L,    KC_SCLN, KC_ENT,
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_HOME,  KC_END, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
        KC_LCTL, MO(_FN), KC_LGUI, KC_LALT, LOWER, MT_LSFT_SPC, MT_LSFT_SPC, MT_LSFT_SPC, MT_LSFT_SPC, RAISE, KC_RALT, KC_UP, KC_RGHT, KC_RCTL
    ),
