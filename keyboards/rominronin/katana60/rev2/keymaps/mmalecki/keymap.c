...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE] = LAYOUT_1_c(/* Base */
    ...
    KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,     KC_G,    KC_BSLASH, KC_SCLN,    KC_H,    KC_J,    KC_K, KC_L,    KC_QUOTE, KC_ENTER,
  ...
  [FN] = LAYOUT_1_c(
    ...
    _______, _______, _______, _______, _______,  _______, _______,    _______,   _______, _______, _______, _______, _______,  KC_DOWN, _______,
